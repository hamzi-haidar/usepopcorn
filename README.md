a React movie web app to search for movies add them to your list after rating them and viewing the total watch time avg rating etc based on your lists. reusable logic and custom hooks are used
